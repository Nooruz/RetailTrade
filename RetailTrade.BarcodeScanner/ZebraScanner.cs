...
namespace RetailTrade.BarcodeScanner
{
    ...
    public static class ZebraScanner
    {
        ...
        #region Public Static Action

        public static event Action<string> OnScanningEvent;
        ...
        {
            OnScanningEvent?.Invoke(Encoding.ASCII.GetString(FromHex(XElement.Parse(pscanData).Descendants("datalabel").Single().Value.Replace(" ", string.Empty))));
        }
