...
namespace RetailTrade.EntityFramework.Migrations
{
    ...
    [Migration("20211110144813_CreateOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderProductOrderToSupplier", b =>
                {
                    b.Property<int>("OrderProductsId")
                        .HasColumnType("int");

                    b.Property<int>("OrderToSuppliersId")
                        .HasColumnType("int");

                    b.HasKey("OrderProductsId", "OrderToSuppliersId");

                    b.HasIndex("OrderToSuppliersId");

                    b.ToTable("OrderProductOrderToSupplier");
                });
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.ProductRefundToSupplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderProductOrderToSupplier", b =>
                {
                    b.HasOne("RetailTrade.Domain.Models.OrderProduct", null)
                        .WithMany()
                        .HasForeignKey("OrderProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RetailTrade.Domain.Models.OrderToSupplier", null)
                        .WithMany()
                        .HasForeignKey("OrderToSuppliersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
