...
namespace RetailTrade.EntityFramework.Migrations
{
    ...
    [Migration("20220613161901_ProductBarcodeView")]
    partial class ProductBarcodeView
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.PriceProduct", b =>
                {
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.TypePrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.PriceProduct", b =>
                {
                    b.HasOne("RetailTrade.Domain.Models.Product", "Product")
                        .WithMany("PriceProducts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RetailTrade.Domain.Models.TypePrice", "TypePrice")
                        .WithOne("PriceProduct")
                        .HasForeignKey("RetailTrade.Domain.Models.PriceProduct", "TypePriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
