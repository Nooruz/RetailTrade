...
namespace RetailTrade.EntityFramework.Migrations
{
    ...
    [Migration("20220915025126_UpdateMoveProducts")]
    partial class UpdateMoveProducts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 9,
                            Name = "Корректировка остатков в кассе"
                        },
                        new
                        {
                            Id = 10,
                            Name = "Корректировка остатков на счете"
                        },
                        new
                        {
                            Id = 11,
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.EnterProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.PointSale", b =>
                {
                    ...
                    b.Property<bool>("AccountingBalances")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.ProductBarcode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.UserPointSale", b =>
                {
                    b.Property<int>("PointSaleId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PointSaleId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("UserPointSales", (string)null);
                });
            ...
            modelBuilder.Entity("RetailTrade.Domain.Views.MoveDocumentView", b =>
                {
                    b.Property<decimal>("Amount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("RetailTrade.Domain.Views.ProductBarcodeView", b =>
                {
                    ...
                    b.ToView("ProductBarcodeView");
                });

            modelBuilder.Entity("RetailTrade.Domain.Views.ProductSaleView", b =>
                {
                    b.Property<decimal>("DiscountAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("RetailTrade.Domain.Views.ProductWareHouseView", b =>
                {
                    ...
                    b.ToView("ProductWareHouseView");
                });

            modelBuilder.Entity("RetailTrade.Domain.Views.ReceiptView", b =>
                {
                    b.Property<decimal>("AmountWithoutDiscount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToView("ReceiptView");
                });

            modelBuilder.Entity("RetailTrade.Domain.Views.WareHouseView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductWareHouse", b =>
                {
                    ...
                    b.HasOne("RetailTrade.Domain.Models.WareHouse", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.Document", b =>
                {
                    b.HasOne("RetailTrade.Domain.Models.DocumentType", "DocumentType")
                        .WithMany()
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.EnterProduct", b =>
                {
                    ...
                    b.HasOne("RetailTrade.Domain.Models.Registration", null)
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.ProductSale", b =>
                {
                    ...
                    b.HasOne("RetailTrade.Domain.Models.Receipt", null)
                        .WithMany("ProductSales")
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.Refund", b =>
                {
                    b.HasOne("RetailTrade.Domain.Models.Receipt", "Receipt")
                        .WithOne("Refund")
                        .HasForeignKey("RetailTrade.Domain.Models.Refund", "ReceiptId");
            ...
            modelBuilder.Entity("RetailTrade.Domain.Models.UserPointSale", b =>
                {
                    b.HasOne("RetailTrade.Domain.Models.PointSale", "PointSale")
                        .WithMany("UserPointSale")
                        .HasForeignKey("PointSaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RetailTrade.Domain.Models.User", "User")
                        .WithMany("UserPointSales")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
